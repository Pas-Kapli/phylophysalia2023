      ...
      Imapfile = ../../../../baobab/baobab.map.txt
       outfile = out.model4.txt
      mcmcfile = mcmc.model4.txt
  ...
  species&tree = 6  Adig Agra Agre Amad Arub Smic
                    3 2 1 2 2 1
                  (Smic, (Agre,((x[&phi=0.200000,tau-parent=no],Adig)w,((z[&phi=0.200000,tau-parent=no],Arub)y,((Agra)x[&phi=0.800000,tau-parent=yes],(Amad)z[&phi=0.800000,tau-parent=yes])e)d)c)b)a;
        phase = 0 0 0 0 0 0
